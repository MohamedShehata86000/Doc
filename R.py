...
base_url = "https://t.me/tasapqta3at/"
uk="https://t.me/M_S_H_VIP1/"

def repeat():
    random_value = random.randint(1, 1105)
    random_value2 = random.randint(1, 142)
    url1 = base_url + str(random_value)
    url2=uk+ str(random_value2)
    url3=[url1,url2]
    url=random.choice(url3)
    print(url)
